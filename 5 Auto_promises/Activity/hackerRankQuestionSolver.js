...
browserPromise
    ...
    .then(function () {
        ...
        let emailWillBeTypedPromise = gtab.type("#input-1", email, { delay: 0 });
        return emailWillBeTypedPromise;
    }).then(function () {
        let passwordWillBeTypedPromise = gtab.type("#input-2", password, { delay: 0 });
...
function questionSolver(modulepageUrl, code, questionName) {
    return new Promise(function (resolve, reject) {
        ...
        reachedPageUrlPromise
            ...
            .then(function () {
                // checkbox click
                let inputWillBeClickedPromise = waitAndClick(".custom-checkbox");
            ...
            .then(function () {
                let controlIsHoldPromise = gtab.keyboard.up("Control");
                return controlIsHoldPromise;
            })
            .then(function () {
